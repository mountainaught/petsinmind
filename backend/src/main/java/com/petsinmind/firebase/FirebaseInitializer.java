...
/**
 * This class initializes Firebase with the service account key, keep the key in
 * the resources file and dont push it to the repository
 * 
 * it should be called once in the start of the application i.e Main.java
 * 
 * it loads the servce account key from the resources file and initializes the
 * Firebase app i.e connecting to the Firebase database
 * 
 * 
 * 
 */
...
public class FirebaseInitializer {
    ...
    /*
     * This method initializes the Firebase app with the service account key before
